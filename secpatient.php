...
<div id="myModalupdatepation" class="modal fade" role="dialog">
  ...
  padding: 8px 12px; margin: auto;margin-top: 0px; margin-left: 563px;border-radius: 0px 5px 0px 0px;" type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        <form method="POST" action="secpatient.php">
      ...
      <input style="margin-left:0px;width:auto;" type="text" name="nom" id="nom" value="<?php echo $nom ;?>" required ><br>
      <label  style="display:inline;" for="prenom"> prenom  :</label>
      <input style="margin-left:0px;width:auto;" type="text" name="prenom"id="prenom" value="<?php echo $prenom ;?>" required><br>
      <label   style="display:inline;" for="email">Email  :</label>
      <input style="margin-left:0px;width:auto;" type="email" name="email"id="email"value="<?php echo $email ;?>" required><br>
      <label  style="display:inline;" for="telf"> Tel  :</label>
      <input style="margin-left:0px;width:auto;" type="numbre" maxlength="10" name="numerotelf" id="telf" value="<?php echo $numerotelf ;?>" required ><br>
      <label  style="display:inline;" for="group"> groupage :</label>
      <input style="margin-left:0px;width: 50px;" type="text" maxlength="3" name="group" id="group" value="<?php echo $groupage ;?>" required ><br>
      <label  style="display:inline;"  for="daten">date_de_naissance :</label>
      <input style="margin-left:0px;width:auto;" type="date" id="daten" name="daten" value="<?php echo $daten ;?>"required><br>
